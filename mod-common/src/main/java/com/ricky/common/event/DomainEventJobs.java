...
public class DomainEventJobs {
    ...
    public void removeOldWebhookEventsFromRedis(int count, boolean approximate) {
        ...
        Long webhookEventCount = stringRedisTemplate.opsForStream().trim(redisProperties.getWebhookStream(), count, approximate);
    ...
    public void removeOldNotificationEventsFromRedis(int count, boolean approximate) {
        ...
        Long notificationEventCount = stringRedisTemplate.opsForStream().trim(redisProperties.getNotificationStream(), count, approximate);
