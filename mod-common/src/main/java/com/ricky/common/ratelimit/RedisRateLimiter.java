package com.ricky.common.ratelimit;
...
import static com.ricky.common.exception.ErrorCodeEnum.TOO_MANY_REQUEST;
...
public class RedisRateLimiter implements RateLimiter {
    ...
    private void doApply(String key, int limit, int expire, TimeUnit expireUnit) {
        ...
        if (isNotBlank(count) && Integer.parseInt(count) >= limit) {
            throw new MyException(TOO_MANY_REQUEST, "当前请求量过大。", Map.of("key", finalKey));
        }
