package com.ricky.common.validation.mobileoremail;
...
public class MobileOrEmailValidator implements ConstraintValidator<MobileOrEmail, String> {
    ...
    private static final Pattern MOBILE_PATTERN = Pattern.compile(RegexConstants.MOBILE_PATTERN);
    private static final Pattern EMAIL_PATTERN = Pattern.compile(RegexConstants.EMAIL_PATTERN, CASE_INSENSITIVE);
